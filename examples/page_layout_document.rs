use hwpers::{HwpWriter, writer::style::TextStyle};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    writer.add_paragraph("좁은 여백 (12.7mm)으로 설정되었습니다. 더 많은 내용을 페이지에 넣을 수 있습니다.")?;
    writer.add_paragraph("")?;
    ...
    writer.add_paragraph("넓은 여백으로 설정되었습니다. 좌우 50.8mm, 상하 25.4mm의 여백을 가집니다.")?;
    writer.add_paragraph("")?;

    // Custom margins
    writer.add_heading("사용자 정의 여백", 3)?;
    writer.set_page_margins_mm(20.0, 15.0, 25.0, 10.0)?;
    writer.add_paragraph("사용자 정의 여백이 설정되었습니다: 왼쪽 20mm, 오른쪽 15mm, 위쪽 25mm, 아래쪽 10mm")?;
    writer.add_paragraph("")?;
    ...
    writer.add_paragraph("이제 텍스트가 3개의 좁은 단으로 나뉩니다. 이는 뉴스레터나 브로셔에 적합한 레이아웃입니다.")?;
    writer.add_paragraph("")?;
    ...
    writer.add_paragraph("")?;
    writer.add_paragraph("이러한 기능들을 활용하여 전문적이고 아름다운 문서를 만들 수 있습니다.")?;
