...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let custom_hyperlink = hwpers::model::hyperlink::Hyperlink::new_url("특별한 링크", "https://special.example.com")
    ...
    // Green file link
    let green_link = hwpers::model::hyperlink::Hyperlink::new_file("중요한 문서", "./important.pdf")
