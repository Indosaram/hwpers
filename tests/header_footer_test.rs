use hwpers::{HwpWriter, model::{PageApplyType, HeaderFooterAlignment, PageNumberFormat}};
...
fn test_basic_header() {
    ...
    // Add basic content
    writer.add_paragraph("This is a document with header.").unwrap();
...
fn test_basic_footer() {
    ...
    writer.add_paragraph("This is a document with footer.").unwrap();
...
fn test_multiple_headers_and_footers() {
    ...
    writer.add_header_with_options("First Page Header", PageApplyType::FirstPage, HeaderFooterAlignment::Center);
    writer.add_header_with_options("Odd Page Header", PageApplyType::OddPages, HeaderFooterAlignment::Left);
    writer.add_header_with_options("Even Page Header", PageApplyType::EvenPages, HeaderFooterAlignment::Right);
...
fn test_mixed_document_with_headers_footers() {
    ...
    writer.add_paragraph("This is the first paragraph.").unwrap();
