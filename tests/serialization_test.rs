...
fn test_hyperlink_serialization() {
    ...
    let hyperlink =
        hwpers::model::hyperlink::Hyperlink::new_url("Rust Homepage", "https://rust-lang.org");

    // Add paragraph with hyperlink
    writer
        .add_paragraph_with_hyperlinks(
...
fn test_header_footer_serialization() {
    ...
    // Add some content
    writer
        .add_paragraph("This is the main content of the document.")
...
fn test_page_layout_serialization() {
    ...
    writer
        .set_page_margins_mm(20.0, 20.0, 20.0, 20.0)
        .expect("Failed to set margins");

    // Add content
    writer
        .add_paragraph("Test page with custom layout")
        .expect("Failed to add paragraph");
